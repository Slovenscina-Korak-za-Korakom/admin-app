          ...
          <div className="w-full flex flex-col justify-center space-y-6 lg:pt-16">
            <div>
              ...
              <p className="text-base text-muted-foreground leading-relaxed max-w-lg">
                We&apos;re working hard to build a comprehensive session
                management system. Once ready, you&apos;ll be able to view,
                schedule, and manage all your tutoring sessions in one place. We&apos;ll
